// 📁 commands/whitelist.js const { getSetting, setSetting } = require('../database/settings'); const isAdmin = require('../raymond/isAdmin');

// In-memory store for whitelisted numbers const whitelist = new Set();
...
isWhitelisted(jid) { return whitelist.has(jid); } };
